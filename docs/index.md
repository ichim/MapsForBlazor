<div class="md-hero"  style="background-image: url('assets/banner2.png'); 
            ...
            padding-top: 98px;                 /* ← ajustează această valoare */
            position: relative;">
...
<div style="position: absolute; bottom: 10px; left: 10px; display: flex; gap: 12px;">
  ...
  <a href="https://github.com/ichim/MapsForBlazor-nuget" target="_blank" 
     ...
     onmouseover="this.style.backgroundColor='rgba(255,255,255,0.80)'"
